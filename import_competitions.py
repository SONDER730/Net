...
# 设置 Django 环境
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'NetSecLab.settings')  # 确保路径正确
django.setup()

from More_apps.competition_announcement.models import Competition  # 放在 django.setup() 之后
